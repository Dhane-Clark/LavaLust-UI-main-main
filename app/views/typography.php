...
<html class="wide wow-animation" lang="en"> 
  ...
  <body>
    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="typography">Typography</a>
                      </li>
      ...
      <section class="parallax-container overlay-1" data-parallax-img="public/site/images/breadcrumbs.jpg">
